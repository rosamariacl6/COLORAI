  ...
  const onSubmit = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (editUser.type === 2) {
          navigate(`/oneUser/${editUser.user_id}`);
        } else if (editUser.type === 1) {
          navigate(`/oneUserProfessional/${editUser.user_id}`);
        } else if (editUser.type === 3) navigate(`/homeAdmin`);
    ...
    <>
      <Row>
        ...
        <div className="ContainEdit">
          <Col className="d-flex flex-column edit-user crear-form justify-content-center align-items-center">
            ...
            <div>
              <h1 className="text-white text-center pb-3">
                Editar datos de{" "}
                {editUser?.type === 2 ? "cliente" : "profesional"}
              </h1>
            </div>
